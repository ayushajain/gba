...
GameBoyCore.prototype.initLCD = function () {
	...
	this.drawContextOnscreen = this.canvas.getContext("webgl-2d");
	...
	"-ms-interpolation-mode: " + ((settings[13]) ? "bicubic" : "nearethis.canvasBufferst-neighbor") + ";");
	...
	this.canvasBuffer = this.drawContextOnscreen.createImageData(this.offscreenWidth, this.offscreenHeight);
	while (index > 0) {
